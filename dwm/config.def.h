...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_F10,    	       spawn,          SHCMD("~/Scripts/volume.sh toggle") },
    { MODKEY,                       XK_F11,    	       spawn,          SHCMD("~/Scripts/volume.sh 5%-") },
    { MODKEY|ShiftMask,             XK_F11,    	       spawn,          SHCMD("~/Scripts/volume.sh 1%-") },
    { MODKEY,                       XK_F12,    	       spawn,          SHCMD("~/Scripts/volume.sh 5%+") },
    { MODKEY|ShiftMask,             XK_F12,    	       spawn,          SHCMD("~/Scripts/volume.sh 1%+") },
